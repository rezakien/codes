...
namespace GameMontebank
{
    public partial class Form1 : Form
    {
        ...
        public void ShowControlsForAdding()
        {
            ...
            Cash = new TextBox();
            Cash.Location = new Point(textBox1.Location.X, textBox1.Location.Y);
            Cash.Size = textBox1.Size;
            Cash.Font = textBox1.Font;
            this.Controls.Add(Cash);

            //CashLabel label options
            CashLabel = new Label();
            CashLabel.Location = new Point(textBox1.Location.X - 150, textBox1.Location.Y);
            ...
            Namee = new TextBox();
            Namee.Location = new Point(textBox1.Location.X, textBox1.Location.Y - 80);
            Namee.Size = textBox1.Size;
            Namee.Font = textBox1.Font;
            this.Controls.Add(Namee);

            //Name label options
            NameLabel = new Label();
            NameLabel.Location = new Point(textBox1.Location.X - 150, textBox1.Location.Y - 80);
        ...
        public void CheckWinners()
        {
            ...
            if (k == 0) { s.croupier.LostBets += res; }
        }
        ...
        {
            Form1.ActiveForm.BackColor = ColorTranslator.FromHtml("#009900");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            switch (button1.Text.ToString())
            {
                case "Begin":
                    if (textBox1.Text != "")
                    {
                        s.SessionCashLimit = double.Parse(textBox1.Text);
                        HideControls();
